...
<template>
    <Head title="CMS | Pengaturan Situs" />
                ...
                <div class="bg-white shadow sm:rounded-lg overflow-hidden">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-500 mt-1">
                            Ubah tautan eksternal atau kontak yang sering
                            berubah di sini agar tercermin di seluruh website.
                        </p>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        >
                            <label
                                ...
                                >{{ formatKeyName(setting.key) }}</label
                            >
                            ...
                            <p class="mt-1 text-xs text-gray-400">
                                Key Identifier: <code>{{ setting.key }}</code>
                            </p>
                        </div>
                    </div>
                </div>
