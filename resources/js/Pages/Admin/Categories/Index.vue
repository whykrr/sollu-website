...
const deleteCategory = (category) => {
    if (
        confirm(
            `Yakin ingin menghapus kategori "${category.name}"? Kategori ini hanya bisa dihapus jika tidak memiliki artikel.`,
        )
    ) {
...
<template>
    <Head title="CMS | Kelola Kategori" />
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                ...
                <div
                    v-if="showAddForm"
                    class="mb-6 bg-white shadow sm:rounded-lg p-6"
                >
                    ...
                    <form @submit.prevent="addCategory" class="flex gap-3">
                        ...
                        <button
                            ...
                            class="px-4 py-2 bg-gray-100 text-gray-600 rounded-md text-sm hover:bg-gray-200 transition"
                        >
                            Batal
                        </button>
                    </form>
