        ...
        <div class="py-12">
            <div class="mx-auto max-w-5xl sm:px-6 lg:px-8 space-y-6">
                ...
                <div
                    ...
                    class="p-4 bg-green-50 text-green-700 rounded-lg border border-green-200"
                >
                    {{ $page.props.flash.success }}
                </div>

                <p class="text-sm text-gray-500">
                    Atur meta title, meta description, dan OG image untuk setiap
                    halaman publik. Pengaturan ini mempengaruhi tampilan website
                    Anda di hasil pencarian Google dan saat di-share ke media
                    sosial.
                </p>
                    ...
                    >
                        <div>
                            <h3 class="text-lg font-bold text-gray-800">
                                {{ formatPageName(setting.page_slug) }}
                            </h3>
                            <p class="text-xs text-gray-400 mt-0.5">
                                Rute:
                                <code class="bg-gray-100 px-1.5 py-0.5 rounded"
                                    >/{{
                                        setting.page_slug === "home"
                                            ? ""
                                            : setting.page_slug
                                    }}</code
                                >
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <span
                                    :class="[
                                        'text-xs font-mono',
                                        titleCharCount(setting.meta_title) > 60
                                            ? 'text-red-500'
                                            : 'text-gray-400',
                                    ]"
                                    >{{ titleCharCount(setting.meta_title) }} /
                                    60</span
                                >
                            </div>
                            <input
                                type="text"
                                v-model="form.settings[index].meta_title"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
                                placeholder="Judul halaman untuk mesin pencari..."
                            />
                            <p class="mt-1 text-xs text-gray-400">
                                Disarankan 50-60 karakter agar tidak terpotong
                                di hasil pencarian.
                            </p>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <span
                                    ...
                                    >{{
                                        descCharCount(setting.meta_description)
                                    }}
                                    / 160</span
                                >
                            </div>
                            <textarea
                                v-model="form.settings[index].meta_description"
                                rows="3"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
                                placeholder="Deskripsi singkat halaman untuk mesin pencari..."
                            ></textarea>
                            <p class="mt-1 text-xs text-gray-400">
                                Disarankan 120-160 karakter agar tampil optimal
                                di SERP.
                            </p>
                        </div>
                        ...
                        <div>
                            <label
                                ...
                                >Open Graph Image (OG Image)</label
                            >
                            <div class="flex items-start gap-4">
                                <div
                                    v-if="setting.og_image_url"
                                    class="shrink-0"
                                >
                                    <img
                                        :src="setting.og_image_url"
                                        class="h-20 w-36 object-cover rounded-lg border border-gray-200"
                                    />
                                </div>
                                <div class="flex-1 space-y-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        >
                                            <button
                                                type="button"
                                                class="px-3 py-2 bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-md text-sm font-medium text-gray-700 transition"
                                            >
                                                Upload
                                            </button>
                                            <input
                                    ...
                                    <p class="text-xs text-gray-400">
                                        Gambar yang ditampilkan saat link
                                        di-share ke sosial media. Rekomendasi:
                                        1200×630 px.
                                    </p>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div class="space-y-1">
                                <p
                                    class="text-blue-700 text-lg font-medium truncate hover:underline cursor-pointer"
                                >
                                    {{
                                        setting.meta_title ||
                                        "Judul Halaman — Sollu POS"
                                    }}
                                </p>
                                ...
                                <p class="text-sm text-gray-600 line-clamp-2">
                                    {{
                                        setting.meta_description ||
                                        "Deskripsi halaman akan ditampilkan di sini..."
                                    }}
                                </p>
                            </div>
                        </div>
