                ...
                >
                    <div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link
                                href="/services"
                                class="flex items-center justify-center gap-2 bg-white text-gray-700 border border-gray-200 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-50 hover:border-gray-300 transition-all"
                            >
                                Pelajari Fitur
                            </Link>
                        </div>
        ...
        <section class="py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h2
                        class="text-3xl font-heading font-bold text-gray-900 mb-4"
                    >
                        {{
                            pageContents?.features?.title ||
                            "Fitur Lengkap Sollu POS"
                        }}
                    </h2>
                    <p class="text-lg text-gray-600">
                        {{
                            pageContents?.features?.subtitle ||
                            "Penuhi kebutuhan bisnis anda."
                        }}
                    </p>
                </div>
