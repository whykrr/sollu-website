...
<template>
    <Head :title="seo?.meta_title || 'Hubungi Kami'">
        <meta
    ...
    <MainLayout>
        ...
        <div class="py-20 bg-gray-50">
            <div
                class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 relative z-20"
            >
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mb-3 text-sm">
                                    Konsultasi cepat via WhatsApp dengan
                                    spesialis kami.
                                </p>
                                <a
                                    :href="
                                        'https://wa.me/' +
                                        (siteSettings?.wa_number ||
                                            '6281112345678')
                                    "
                                    class="text-primary-600 font-bold hover:text-primary-800 transition"
                                    >+{{
                                        siteSettings?.wa_number ||
                                        "62 811 1234 5678"
                                    }}</a
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mb-3 text-sm">
                                    Untuk pertanyaan kerjasama atau detail
                                    teknis.
                                </p>
                                <a
                                    :href="
                    ...
                    >
                        ...
                        <p class="text-gray-500 mb-8">
                            Isi formulir di bawah ini dan representatif sales
                            kami akan segera menghubungi Anda maksimal dalam
                            1x24 jam.
                        </p>

                        <div
                            v-if="isSuccess"
                            class="mb-8 p-4 bg-green-50 text-green-700 rounded-xl border border-green-200 flex flex-col items-center justify-center text-center"
                        >
                            <h4 class="font-bold text-lg mb-1">
                                Pesan Berhasil Terkirim!
                            </h4>
                            <p class="text-sm opacity-90">
                                Terima kasih telah menghubungi kami. Kami akan
